...
namespace ChoirSubscriptionManager.Data.Migrations
{
    ...
    [Migration("20250607015851_InitialCreate")]
                    ...
                    b.ToTable("Subscriptions", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_Subscription_Month", "Month >= 1 AND Month <= 12");

                            t.HasCheckConstraint("CK_Subscription_Year", "Year >= 2020");
                        });
                });
